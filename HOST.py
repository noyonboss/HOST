...
while attemps < 12345677901:
    ...
    if username == 'PAID' and password == 'BRO':
...
os.system('espeak -a 300 " Welcome,   to,  NOYON,  King,  Tools"')
...
>>   db   db  .d88b.  .d8888. d888888b  N                                      >>   88   88 .8P  Y8. 88'  YP `~~88~~'  O
>>   88ooo88 88    88 `8bo.      88     Y                                      >>   88~~~88 88    88   `Y8b.    88     O
>>   88   88 `8b  d8' db   8D    88     N
>>   YP   YP  `Y88P'  `8888Y'    YP   
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
                                       \033[1;92m                
[+] OWNER    : NOYON
...
def Settings():
	...
	pwplus=input('\033[1;97m[ 1 ] 𝙽𝙴𝚆 Facebook [𝙶𝙾????]\n[ 2 ] 𝙽𝙴𝚆 + 𝙾𝙻𝙳 Facebook [𝚅𝙴𝚁𝚈 𝙶𝙾𝙾??]\n\033[1;97m\33[1;95m𝙲𝚑𝚘𝚒𝚌𝚎 :\33[1;92m')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
	...
	print(f"\x1b[1;97m---------------------------------------------------------------------")
def passwrd():
	print(f"\x1b[1;97m[~] Welcomed TO TOOL NOYON CRACKER")
	print('\x1b[1;97m[~] TOTAL iDs\x1b[1;98m',str(len(id)))  
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[NOYON-HOST] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
